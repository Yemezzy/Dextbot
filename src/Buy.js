...
<section className='flex items-center font-bold'>
           <img className='w-12' src="https://apiable.s3.eu-central-1.amazonaws.com/public/noisyrosehamstergb1xz5/d2db3a30-8a35-457e-ade6-84f6e7677ad4.png" alt="" />
           <p>DEXT<span>BOT</span></p>
           </section>
</Link>
          ...
          <Link to="/buy-dextbot">
          <button className='py-2 text-sm bg-[#1BB8D8] text-white rounded-full px-5 md:mr-10'>
            Buy the Bot
          </button>
          </Link>
        </nav>
...
<p className='text-center font-semibold text-lg mt-10'> See Available Prices</p>

<div className='md:mt-10 mt-3 md:flex justify-center gap-10'>
    <section className='md:w-[25%] border-2 border-[#1BB8D8] px-3 py-5'>
<p className='uppercase text-center mt-5 font-swmibold text-xl'>Standard Plan</p>
...
<div className=''>
    ...
    <p className='mt-5 text-sm h-[70px]'>The Standard DEXTBOT restarts after every 24 hours of trending.</p>
    <button onClick={handleOpen} className='py-3 bg-[#1BB8D8] mt-5 text-white  font-bold w-full'>
        BUY NOW
    </button>
</div>
    </section>
    <section className='md:w-[25%] mt-3 md:mt-0 border-2 border-[#1BB8D8] px-3 py-5'>
<p className='uppercase text-center mt-5 font-swmibold text-xl'>Advanced Plan</p>
...
<div className=''>
    ...
    <p className='mt-5 text-sm h-[70px]'>The Advanced DEXTBOT replaces any project on the current number with your project and maintain the poistion for your project to countinue trending.</p>
    <button onClick={handleOpen} className='py-3 bg-[#1BB8D8] mt-5 text-white font-bold w-full'>
        BUY NOW
    </button>
</div>
    ...
    <section className='md:w-[25%] mt-3 md:mt-0 border-2 border-[#1BB8D8] px-3 py-5'>
<p className='uppercase text-center mt-5 font-swmibold text-xl'>pro Plan</p>
...
<div className=''>
    ...
    <p className='mt-5 text-sm h-[70px]'>The PRO DEXTBOT Keeps the project trending non-stop on the given position when activated until the bot is Deactivated.</p>
    <button onClick={handleOpen} className='py-3 bg-[#1BB8D8] mt-5 text-white  font-bold w-full'>
        BUY NOW
    </button>
</div>
   ...
   <section>
<p className='md:text-2xl text-xl font-semibold'>Get news about cryptocurrencies every day!</p>
<p className='md:mt-5 text-sm md:text-base mt-3'>
Be part of DEXT Force community! The premium community of DEXTools</p>

<div className='md:w-[80%]'>
<p className='md:mt-3 mt-2 text-sm'>A group of elite traders and investors focused on DeFi. You can join now our exclusive Telegram and get all community benefits including contests, investing tips and advanced market info. There are 3 tiers:
</p>
...
<p className='mt-3 text-xs pr-3'>Empower your visibility with DextBuyBot, ascend on Dextools.io, and seize the Trending status. Powered by Dextools.io.</p>
   </div>
   <div className='md:w-[30%] mt-3 md:mt-0 p-3 rounded-2xl h-[150px] bg-[#E2E7EC]'>

   <p className='text-sm font-semibold mt-2'>PRICE BOT</p>
<p className='mt-3 text-xs pr-3'>Get the lattest price of your crypto tokens with the Dextool PRICE BOT</p>
   </div>
   <div className='md:w-[30%] mt-3 md:mt-0 p-3 rounded-2xl h-[150px] bg-[#E2E7EC]'>

   <p className='text-sm font-semibold mt-2'>NEW PAIRS BOT</p>
<p className='mt-3 text-xs pr-3'>Keep track of the newely listed crypto tokens on Dextool, NEW PAIR BOT helps in adding your tokend to Dextool.</p>
   </div>
</section>
</div>
   </section>
